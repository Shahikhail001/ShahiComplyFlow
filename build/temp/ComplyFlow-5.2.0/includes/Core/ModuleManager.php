...
class ModuleManager {
    ...
    private function register_core_modules(): void {
        ...
        $this->register_module('html_templates', [
            'name' => __('HTML Templates', 'complyflow'),
            'description' => __('Import and manage HTML templates with dynamic image replacement', 'complyflow'),
            'class' => 'ComplyFlow\Modules\HTMLTemplates\HTMLTemplateModule',
            'enabled_by_default' => true,
            'dependencies' => [],
            'required_capability' => 'manage_options',
            'version' => '1.0.0',
